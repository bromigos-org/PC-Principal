...
const (
	...
	EventTypeUserDiscovered       EventType = "user_discovered"
	EventTypeMemberRoleAssigned   EventType = "member_role_assigned"
	EventTypeMemberRoleUnassigned EventType = "member_role_unassigned"
